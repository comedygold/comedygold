...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("comedygoldcoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("comedygoldcoin://"))
    {
        uri.replace(0, 11, "comedygoldcoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "ComedyGold.lnk";
}
...
{
    return GetAutostartDir() / "comedygoldcoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("ComedyGold-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  comedygoldcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("ComedyGold-Qt"));
