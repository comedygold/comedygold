...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ComedyGold " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"comedygoldcoin.com", "seed.comedygoldcoin.com"},
//    {"comedygoldcoinpool.org", "dnsseed.comedygoldcoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ComedyGold is probably already running."), addrBind.ToString().c_str());
        else
